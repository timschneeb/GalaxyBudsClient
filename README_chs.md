...
**此 README 同样在以下语言可用 [英语](/README.md), [韩语](/README_kor.md), [日语](/README_jpn.md), [俄语](/README_rus.md) 和 [乌克兰语言](/README_ukr.md)!**
...
* 均衡器：解锁“优化杜比”功能<sup>[2]</sup>

> <sup>[1]</sup> 三星官方 Wearable 应用无法处理这些功能
>
...
* [@kakkk](https://github.com/kakkk) 与 [@KevinZonda](https://github.com/KevinZonda) - 汉语翻译
