...
namespace GalaxyBudsClient.Message
{
    ...
    public class DeviceLogManager
    {
        ...
        public async Task BeginDownloadAsync()
        {
            ...
            await BluetoothImpl.Instance.SendRequestAsync(SPPMessage.MessageIds.MSG_ID_LOG_SESSION_OPEN);
        }

        public async Task CancelDownload()
        {
            await BluetoothImpl.Instance.SendRequestAsync(SPPMessage.MessageIds.MSG_ID_LOG_SESSION_CLOSE);
            BluetoothImpl.Instance.MessageReceived -= OnMessageReceived;
        ...
        private async void OnMessageReceived(object? sender, SPPMessage e)
        {
            ...
            {
                #region SESSION
                case SPPMessage.MessageIds.MSG_ID_LOG_SESSION_OPEN:
                    _hasCompletedRoleSwitch = false;
                    if (e.Payload[0] == 0)
                    {
                        await BluetoothImpl.Instance.SendRequestAsync(SPPMessage.MessageIds.MSG_ID_LOG_TRACE_START, 0);
                    }
                    break;
                case SPPMessage.MessageIds.MSG_ID_LOG_SESSION_CLOSE:
                    break;
                #endregion
                
                #region TRACE
                case SPPMessage.MessageIds.MSG_ID_LOG_TRACE_START:
                    ...
                    break;
                case SPPMessage.MessageIds.MSG_ID_LOG_TRACE_DATA:
                    ...
                    break;
                case SPPMessage.MessageIds.MSG_ID_LOG_TRACE_ROLE_SWITCH:
                    ...
                    break;
                case SPPMessage.MessageIds.MSG_ID_LOG_TRACE_DATA_DONE:
                    ...
                    await BluetoothImpl.Instance.SendRequestAsync(SPPMessage.MessageIds.MSG_ID_LOG_TRACE_COMPLETE);
                    ...
                    break;
                case SPPMessage.MessageIds.MSG_ID_LOG_TRACE_COMPLETE:
                    await BluetoothImpl.Instance.SendRequestAsync(SPPMessage.MessageIds.MSG_ID_LOG_COREDUMP_DATA_SIZE);
                    break;
                #endregion
                ...
                case SPPMessage.MessageIds.MSG_ID_LOG_COREDUMP_DATA_SIZE:
                    ...
                    {
                        await BluetoothImpl.Instance.SendRequestAsync(SPPMessage.MessageIds.MSG_ID_LOG_TRACE_ROLE_SWITCH);
                    }
                    break;
                case SPPMessage.MessageIds.MSG_ID_LOG_COREDUMP_DATA:
                    ...
                    break;
                case SPPMessage.MessageIds.MSG_ID_LOG_COREDUMP_DATA_DONE:
                    ...
                    await BluetoothImpl.Instance.SendRequestAsync(SPPMessage.MessageIds.MSG_ID_LOG_COREDUMP_COMPLETE);
                    ...
                    break;
                case SPPMessage.MessageIds.MSG_ID_LOG_COREDUMP_COMPLETE:
