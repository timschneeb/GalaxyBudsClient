...
public class ExperimentResult
{
    ...
    public string? MacAddress => BitConverter.ToString(SHA256.HashData(Encoding.ASCII.GetBytes(DeviceMessageCache.Instance.DebugGetAllData?.LeftBluetoothAddress ?? ""))).Replace("-", "");
