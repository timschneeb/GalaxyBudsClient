    ...
    public DeveloperOptionsDialog()
    {
        ...
        Commands = new List<TaskDialogCommand> {
            new()
            {
                ...
                Command = new MiniCommand((_) => { WindowLauncher.ShowDevTools(MainWindow2.Instance); })
            },
            new()
            {
                ...
                Command = new MiniCommand((_) => { WindowLauncher.ShowTranslatorTools(MainWindow2.Instance); })
            }
        };
